# AGENTS.md, the Misfits house

This is the Misfits production house (`khai-misfits`), raised by khai-stage. The
misfits are written separately, in khai-playwright mode.
...
cp node_modules/@chbrain/khai-arch/templates/template_process.md misfits/<misfit>/process_<name>.md
```
