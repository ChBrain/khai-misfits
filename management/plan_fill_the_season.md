...
- [ ] [P1] The Firefighter's Medal (Repenning & Sterman, "Nobody Ever Gets Credit for Fixing Problems That Never Happened", California Management Review 2001; Bohn, "Stop Fighting Fires", HBR 2000): prevention is invisible and unrewarded while the dramatic last-minute rescue is visible and heroic, so each actor rationally starves prevention and lavishes effort on recovery, capability erodes, and the system tips into permanent firefighting where the one who saves the burning house is decorated and the one who kept it from igniting is unseen, distinct from Shifting the Burden's disuse-atrophy of the fundamental cure and The Shirky Principle's institutional self-preservation in that the engine is a reward-and-visibility asymmetry, the prevented crisis that earns no credit, not a capacity that withers nor a body that needs the problem
