...
title, the check that would have caught Brooks. The slate is deduped against the seventy-two
...
Triage of the rest of the research batch, against REFERENCES.md. Already staged: The Automation Paradox is The Irony of Automation (Bainbridge, "Ironies of Automation", 1983), the same source. Already held: Winner Takes All (Frank & Cook) is carried by The Head Start's winner-take-all vector. Held off as too adjacent: The Feature Factory (output over outcome) to Metric Fixation; the Technical Debt spiral (Cunningham) to Seed Corn and Shifting the Burden; The Empty Chair (Freeman) to The Decision Travels; The Expert Trap to The Mirror, its Challenger and Columbia record already the spine of The New Normal. Under review, pending a fit-or-distinctness call: The Double Bind (Bateson 1956), a real trap but a contradictory-injunction structure rather than the house's locally-rational-sums-to-globally-bad shape; the signaling or knowledge-economy trap (Spence; Arrow; Caplan), distinct in that the waste is informational but close to The Arms Race's positional escalation; and The Readiness Trap (March 1991), whose preparation-crowds-out-action reading is distinct from The Success Trap's Christensen sourcing yet shares March's exploration-exploitation frame.
