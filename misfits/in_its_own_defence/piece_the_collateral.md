...
# Piece: The Collateral

## Taxonomy

[In Its Own Defence](play_in_its_own_defence.md). The host damage done by the response's own weapons, the tissue struck along with the pathogen, the harm that is not a malfunction but the defence working as it works.
...
Lands in [the Tissue](place_the_tissue.md), wherever the response's weapons fall.
Flows as the wound the guard leaves in the ground it defends, the inflammation and the killing and the signalling reaching the body's own cells in the same act that reaches the invader.
...
Just the cost of battle, some damage where the fight is hardest.
Seen at the surface, the Collateral looks like an acceptable price, the unavoidable mess of a defence pressed home, and the truth that it is not incidental to the response but identical with it, that the weapon clearing the invader is the weapon wrecking the host, that there is no version of the force without the wound, stays hidden behind how readily a little damage reads as the reasonable cost of winning.
