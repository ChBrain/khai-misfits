---
khai: plot
title: "Pinning the Standard First"
language: english
...
# Plot: Pinning the Standard First
...
[The Charter](place_the_charter.md), the concept crept wide and one actor moving to hold the line still.
The count flat, the win invisible, and the means to pin the standard in advance at hand.

## Action

[Anchoring](process_anchoring.md): [The Anchor](persona_the_anchor.md), holding [the anchor's seat](position_anchor.md), would fix the mark and count against it, against [The Seeker](persona_the_seeker.md), holding [the seeker's seat](position_seeker.md), whose reflex is never to stand down, and [The Assessor](persona_the_assessor.md), holding [the assessor's seat](position_assessor.md), whose eye judges by the room.
