...
[The Last Layer](play_the_last_layer.md). The fall of the marginal return, each further layer meeting a harder problem at a higher cost for a smaller yield.
...
Turns a rising benefit into a falling one without changing the method at all.
The society goes on answering problems the same way, but because the easiest and most rewarding solutions are already spent, each new layer costs more and yields less than the one before, so the marginal return on complexity climbs, flattens, and bends over, the classical law of diminishing returns working itself out on problem-solving itself.
