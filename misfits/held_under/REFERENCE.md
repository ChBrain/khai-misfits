...
| **Lexiang Huang, Magnusson, and colleagues** | "Metastable Failures in the Wild" (_OSDI_, 2022)                                                                             | **The field study and the amplification**: real metastable failures from large systems, and the trigger-and-amplification mechanisms, retries and work multiplication, that keep the load above capacity. The Sustaining Load.                            |
