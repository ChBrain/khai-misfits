...
# Piece: The Overstatement

## Taxonomy

[The Best on Paper](play_the_best_on_paper.md). The upward bias selection creates for the chosen option, the conditional fact that the winner's estimate stands above its worth because it was chosen.
...
Without the Overstatement the winning estimate would be as honest as any other, and the choice would not disappoint.
With it the letdown has its cause: the Overstatement is the gap the selection opens between the chosen estimate and its truth (Smith and Winkler; Harrison and March), the winner's number lifted above its worth not by mis-measurement but by having been chosen. The Overstatement is load bearing because it is a bias that exists only conditionally, invisible in the field and undeniable at the top, created by the act of taking the maximum and belonging to the winner alone, so the piece carries the exact mechanism of the curse, the systematic lift selection adds to whatever it picks and the realised value must give back.
