...
Runs across [the field](place_the_field.md), [the pick](place_the_pick.md), and [the outcome](place_the_outcome.md) as the whole arc, the honest slate, the flattered choice, and the shortfall.
Flows through the entire play, from the unbiased valuations to the disappointment they deliver once the top is taken, the curse seen from end to end.
...
Suffered by [the Selector](persona_the_selector.md) who took the top, unmade by [the Sceptic](persona_the_sceptic.md) who would shrink it first, and blamed on no [analyst](persona_the_analyst.md), the whole curse no single step commits.
It is the whole of it: the Letdown is [valuing](process_valuing.md), [maximising](process_maximising.md), [regressing](process_regressing.md), and the refused [shrinking](process_shrinking.md) run as one, [the valuation](piece_the_valuation.md) flattered by selection into [the overstatement](piece_the_overstatement.md) that [the error](piece_the_error.md) inside it made possible, the disappointment stitched into always taking the best on paper.
