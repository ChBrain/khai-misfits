...
[The Unmarked Edge](play_the_unmarked_edge.md). The drift of the operating point toward the boundary, the sum of the adaptations and the economies, each rewarded and none crossing, the emergent slide of the whole system toward the edge.
...
Two gradients that point the same way.
Because the pressure for less effort and the pressure for less cost both run downhill toward the boundary of safe operation, migrating works through their alignment: the moves do not oppose one another but sum, so the lever is the shared direction of the two gradients, which turns many small, sound, unconnected decisions into one steady migration toward the edge they both face.
