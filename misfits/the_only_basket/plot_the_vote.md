...
[The Hearing](place_the_hearing.md), called to order, the room filling with the street that filed the notice.
The agenda item read, the project on the floor, the restriction one vote away.

## Action

[Insuring](process_insuring.md): [The Homeowner](persona_the_homeowner.md), holding [the homeowner's seat](position_homeowner.md), speaks and votes to down-zone the parcel, insuring the value the only way the meeting allows.
