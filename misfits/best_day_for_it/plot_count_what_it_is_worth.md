...
[The Capacity Table](place_the_capacity_table.md) again, when somebody finally measures the captured price instead of the cost.
...
The discovery arrives from a changed question rather than from new evidence: the data was always there, and nothing in the standard series would ever have prompted anybody to ask.

## Tension

What the measure returns is real, quantified and mitigable, which is harder to report than either good news or bad, and it lands in a subject where both sides came wanting a slogan.
