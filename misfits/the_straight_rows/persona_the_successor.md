...
Diligent. Inheriting. Running the plan as handed down.
Is the one who takes over the legible domain a generation on: the forester of the second rotation, the manager of the built city, the officer of the settled scheme, working the grid faithfully as it was designed.
No error wished on them: they run the system exactly as the plan intended, and the plan was vindicated by the first success they inherited.
...
Says "I ran it exactly as the plan says, and I cannot understand why the ground is failing."
Is right that the plan was followed and cannot see that the plan cleared its own foundation, so the diligence is real and the collapse is real and neither is a fault of the hand that met it.
