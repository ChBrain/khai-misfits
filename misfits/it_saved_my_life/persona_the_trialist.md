...
# Persona: The Trialist

## Taxonomy

[The Endpoint](position_the_endpoint.md). Insists the programme be judged by disease-specific mortality in a randomised comparison, not by survival or gratitude, and carries the cold, late null that tells a life saved from a life relabelled, unwelcome to everyone the programme has thanked.
...
Unmoved by the survival curve. Asking who died, not who was diagnosed. Patient enough to wait for the count.
Is the one who refuses the survival rate and the testimony as evidence and asks the only question that separates rescue from relabelling: were there fewer deaths among the screened than among the unscreened, counted over years.
No coldness of heart wished on them: the insistence is not indifference to the grateful but the knowledge that gratitude cannot tell them apart, so the trialist wants the measure precisely because the stories cannot be trusted to protect the people telling them.
...
Says "show me the bodies, not the survivors."
Is the whole correction in one demand, since the survivors are what everyone can see and the bodies, the deaths that did or did not happen, are what the survival rate and the testimony both hide, so the sentence that sounds harsh is the only one that tells a saving from a relabelling, a reading of the programme that begins by refusing the grateful and asking after the dead.
