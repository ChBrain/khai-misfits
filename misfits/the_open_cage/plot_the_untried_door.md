...
[The Open Door](place_the_open_door.md), the situation changed and control returned.
A new manager who would welcome the initiative, a lever that now works, an escape a single step away, and a Subject who carries the old expectation into the new room.

## Action

[Resigning](process_resigning.md): [The Subject](persona_the_subject.md), holding [the subject's seat](position_subject.md), expecting no control, does not test the lever or try the door.
