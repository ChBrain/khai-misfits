...
Runs across [the dearth](place_the_dearth.md), [the harvest](place_the_harvest.md), and [the glut](place_the_glut.md) as the whole turning, the price high, the crop delivered, and the price crashed, round again.
Flows through the entire play, from the first price read to the endless swing it seeds, the cycle traced as one closed loop.
...
Turned by [the Grower](persona_the_grower.md) each season, priced by [the Buyer](persona_the_buyer.md), and broken only by [the Steady Hand](persona_the_steady_hand.md) who plants to the forecast, the whole loop no shock drives.
It is the whole of it: the Cobweb is [reading](process_reading.md), [committing](process_committing.md), [swinging](process_swinging.md), and [chasing](process_chasing.md) run as one closed turn, [the price](piece_the_price.md) read across [the delay](piece_the_delay.md) into [the swing](piece_the_swing.md) that makes the next price, a market that answers itself into a cycle no one meant to start.
