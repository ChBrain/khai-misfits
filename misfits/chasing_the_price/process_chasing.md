...
[The Grower](persona_the_grower.md), at [the Glut](place_the_glut.md), reading the crashed price and planting small, exactly as they read the high price and planted big.
Begins anew each season, since every fresh extreme is a true signal that calls for the same correct answer that produced it.

## Direction

Turns each overshoot into the cause of the next.
The producers answer the low price with a small planting and the high price with a large one, so the crash begets a coming dearth and the spike a coming glut, and chasing carries the swing forward without pause, the market feeding on its own overshoots because each is a real price that deserves a real response.
