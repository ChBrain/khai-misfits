...
[The Console](place_the_console.md), the hundredth time, the aid wrong.
The scan read as clear that is not clear, the route sure of itself that runs into the lake, the operator trained by ninety-nine right answers to trust the aid.

## Action

[Deferring](process_deferring.md): [The Operator](persona_the_operator.md), holding [the operator's seat](position_operator.md), follows the aid past their own contradicting signal, or, no longer watching, misses what it did not flag.
