...
| **Hopp & Mark Spearman**   | _Factory Physics_ (1996)                                                                                                   | **Operationalised**: the VUT relation, variability times a utilisation factor times the process time, and utilisation buffered against variability by slack. The Slack, The Jam.                                   |
