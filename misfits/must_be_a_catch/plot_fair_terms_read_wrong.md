...
[The Table](place_the_table.md), where the offer is made and read for the first time.
...
Neither party errs: the proposer offers what it genuinely means to offer, and the rival reads a rival's offer exactly as a rival's offer should, in general, be read.

## Tension

The better the offer, the more certainly it reads as a trap, so the terms most likely to close the deal are the ones the reading marks least likely to be accepted.
