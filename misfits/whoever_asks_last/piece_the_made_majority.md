...
Declared at [the Division](place_the_division.md), authored on [the Order Paper](place_the_order_paper.md).
Flows as the outcome the other pieces compose, the headless cycle resolved by a sequence that no fair rule can disarm, a winner made and called a mandate.
...
Just the will of the meeting, a decision democratically made.
Seen at the surface, the Made Majority looks like legitimacy itself, an outcome the members reached by fair vote and must therefore own, and the truth that no majority of the room actually prefers it, that its mandate was made by the schedule and not found in the counts, that the most legitimate-looking decision can be the emptiest, stays hidden behind how completely a fairly reached result resembles a genuinely willed one.
