...
[The Habituated](persona_the_habituated.md)'s [set-point](piece_the_set_point.md) has climbed to meet every increase, on [Settle to the Level](plan_settle_to_the_level.md), so [the dose](piece_the_dose.md) is large and [the kick](piece_the_kick.md) is gone, the effect returned to zero from a great height while [the driver](persona_the_driver.md) keeps paying to hold it.
Everything has grown except the result, which is precisely where it was.
