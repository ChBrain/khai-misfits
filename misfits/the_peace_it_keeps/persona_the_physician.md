...
[The Knife](position_the_knife.md). Would lower the line to save the body, and holds only weapons that strike dividing cells, which is what the body's own renewal is, so every measure that spends the clone spends the marrow, and the cure, where it comes, is a trade and not a clean removal.
...
Strikes at the dividing cells and takes the marrow with the clone, titrating a poison that cannot select, easing the body toward remission at the price of the blood it also needs, and holding the patient through the emptied marrow it leaves.
Reaches, in the hardest cases, for the whole replacement, ablating the patient's blood system and rebuilding it from a graft, buying the cure of the disease with a new system that can turn on its host, the benefit and the danger carried in the same cells.
Does what fighting a disease made of the patient requires: not a clean excision but a balance held under time, cutting the line hard enough to win and not so hard as to lose the body to the emptied marrow or the infection, and knowing that to cut the sensitive line too well can leave the resistant remnant the room to return.
