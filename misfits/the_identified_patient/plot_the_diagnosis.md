...
[The Clinic](place_the_clinic.md), a trouble at last that everyone can see.
The symptom real and nameable, the family relieved to have something to point to, the clinician ready to treat the one who is brought.

## Action

[Treating](process_treating.md): [The Clinician](persona_the_clinician.md), holding [the clinician's seat](position_clinician.md), takes the referral and treats the symptom, while [The Kin](persona_the_kin.md), holding [the kin's seat](position_kin.md), names the one as the problem.
