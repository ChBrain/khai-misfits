...
| ------------------------------------------ | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **The law of the thing**                   | Hyrum's law, after Hyrum Wright                                                               | **The statement**: with a sufficient number of users of an API, it does not matter what you promise in the contract, since all observable behaviours of your system will be depended on by somebody.                        |
