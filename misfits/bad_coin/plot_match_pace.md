...
[The queue](place_the_queue.md), the throughput board, and the careful maker falling down it.
On equal terms, the quick clears three pieces to the careful one's one, and the board scores the count, so care is no longer just unpaid, it is losing.
