...
# Plan: Search Past the Answer

## Taxonomy

A **standing plan**: the intent of [the Second Look](position_the_second_look.md), inside [The Good Move](play_the_good_move.md).

## Owner

- Owner: [The Second Look](position_the_second_look.md)
...
([The Doubter](persona_the_doubter.md) finds the good answer as fast as anyone and then makes themselves look again, into the ground the good move would skip, buying the better move, when there is one, with the doubt of all the answers that were already best.)

## Implementation

([The Blind Spot](place_the_blind_spot.md); against the [blocking](process_blocking.md) and [settling](process_settling.md) processes; the Doubter refuses to let [the first answer](piece_the_first_answer.md) close the case, breaking [the fixation](piece_the_fixation.md)'s hold on the gaze to reach [the simpler way](piece_the_simpler_way.md) that [the set](piece_the_set.md) had hidden.)
